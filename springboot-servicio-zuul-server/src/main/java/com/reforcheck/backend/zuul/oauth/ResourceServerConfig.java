...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(ConstantsApp.URI_ZUUL_OAUTH).permitAll()
				.antMatchers(HttpMethod.GET, ConstantsApp.URI_ZUUL_ARMARIOS, ConstantsApp.URI_ZUUL_GET_ALL_PRODUCTOS,
						ConstantsApp.URI_ZUUL_GET_ALL_ITEMS, ConstantsApp.URI_ZUUL_USUARIOS, ConstantsApp.URI_ZUUL_UNITS)
				.permitAll()
				.antMatchers(HttpMethod.GET, ConstantsApp.URI_ZUUL_ARMARIO, ConstantsApp.URI_ZUUL_GET_PRODUCTO, ConstantsApp.URI_ZUUL_GET_ITEM,
				...
				.antMatchers(ConstantsApp.URI_ZUUL_GENERIC_ELEMENTOS, ConstantsApp.URI_ZUUL_GENERIC_PRODUCTOS, ConstantsApp.URI_ZUUL_GENERIC_ITEMS,
